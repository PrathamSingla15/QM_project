...
OPEN_TEXT_POOL = [
    # English, chat-style / mild typos (majority)
    "a fixed schedule like a shuttle bus would realy help",
    "late night avaibility is the biggest isssue for us",
    "gps tracking would be gr8 so we know when the rick will come",
    ...
    "show driver name n photo in the app for safety",
    "book in advance for post class pickup we all leave together",
    "drivers r rude when its a short distance ride",
    "visible fare chart needed its diff every single ride",
    "group booking with frnds on same rick should be allowed",
    "reduce 4 seat min in off peak even 2 passengers is fine",
    "night time me rick milna almost impossible after 10pm",
    "need proper driver tracking so we know how far they are",
    "library se hostel late night fixed rick would b a lifesaver",
    "empty ricks going back is such a waste seen it so many times",
    "lhc ke samne sham ko huge line lag jati hai",
    "rick wait karte karte class miss ho jati hai kai baar",
    "drivers short distance pe attitude dikhate hain",
    "sometimes i wait 15 mins n still no rick comes",
    "app se book karna possible ho jaye toh bahot easy ho jayega",
    "please do something abt late night hostels are far from dept",
    "ek saath 5 ricks aati hai phir ghante bhar kuch nahi",
    "the 4 seat wait is the worst part specially off peak",
    "idk why drivers just wait forever then say full ho gayi",
    "need a proper booking system like ola uber but for campus",
    "some kind of eta would be so helpful tbh",
    "drivers should not wait so long for 4th seat in off peak hrs",
    "rick sometimes takes weird routes which wastes everyones time",
    "main gate se dept tak seedha jaaye rick thats all we want",
    "price varies every ride its annoying pls standardise",
    "sunday late evening literally no rick available",
    "group pickups post lab would save everyone time",
    # A couple with terminal punctuation preserved (minority)
    "An app would solve 80% of the problems we face daily.",
    "Drivers should be trained for basic customer service etiquette.",
]
