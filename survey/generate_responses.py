...
OPEN_TEXT_POOL = [
    # Hinglish / chat-style (bulk)
    "fixed schedule jaise shuttle bus ho toh easy ho jayega",
    "late night koi rick nahi milta library se hostel aana mushkil hota hai",
    "gps tracking hona chahiye pata toh chale kitne min me aayega",
    "per seat fare zyada sahi hai full pay karna galat hai",
    "hostel aur academic area ke liye alag alag rick chalne chahiye",
    "driver change hi nahi rakhte har baar problem hoti hai",
    "app ho jaye toh main gate pe itna wait nahi karna padega",
    "ladies ke liye dedicated rick at night please",
    "driver ka naam aur photo app me dikhna chahiye safety ke liye",
    "advance booking option do class ke baad sab ek saath niklte hai",
    "drivers short distance pe attitude dikhate hai",
    "fare chart visible ho har ride pe alag daam lete hain bhaiya log",
    "group booking hone chahiye friends ke sath same rick me",
    "4 seat fill hone ka wait kyu off peak me 2 bhi chal jaye",
    "rick wait karte karte class miss ho jati hai kai baar",
    "driver bohot der wait karwata hai phir bolta full ho gayi",
    "payment ka issue rehta hai chutta nahi hota kabhi",
    "ek saath 5 ricks aati hai phir ghante bhar nahi dikhti",
    "online booking ho jaye toh kafi convenient rahega",
    "library se hostel late night fixed rick chahiye",
    "driver phone pe baat karte karte chalata hai safety ka issue",
    "price standard hona chahiye 10 se 30 tak kuch bhi le lete hai",
    "empty rick wapas jati hui dikhti hai bahut waste",
    "LHC ke samne sham ko line lag jati hai",
    "book karne ka proper system ho toh bahut help hoga",
    # English, mild typos, chat case
    "Fixed schedule like a shuttle bus would realy help",
    "Late-night avaibility is the biggest isssue for us",
    "GPS tracking would be gr8 so we know when rick will come",
    "Per seat fare is much better than paying full for detours",
    "separate ricks for hostel and academic zones plz",
    "drivers shud carry change i never have exact money",
    "having an app will save soo much time at main gate",
    "womens only rick at night would be really helpful",
    "show driver name n photo in app for safety",
    "book in advance for post class pickup we all leave together",
    "drivers r rude when its a short distance ride",
    "visible fare chart needed its different every single ride",
    "group booking with frnds on same rick should be allowed",
    "reduce 4 seat min in off peak even 2 passengers is fine",
    "night time ke liye alag system hona chahiye",
    "driver tracking karna chahiye taaki pata chale kahan tak pahuncha",
    # A couple with terminal punctuation preserved (minority)
    "An app would solve 80% of the problems we face daily.",
    "Please introduce cashless payment — UPI would be ideal.",
]
